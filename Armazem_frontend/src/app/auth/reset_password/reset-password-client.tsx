...
export default function ResetPasswordClient() {
  ...
  const handleRequest = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // resposta idempotente por segurança
      Swal.fire({
        title: 'Verifique seu e-mail',
        text: 'Se o e-mail existir em nossa base, enviaremos as instruções para resetar a senha.',
        icon: 'success',
  ...
  const handleConfirm = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (status === 400) setTokenStatus('invalid');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="dark">
      <main className="min-h-screen flex flex-col relative overflow-hidden bg-zinc-900">
        {/* background */}
        <div
        ...
        {/* conteúdo central ocupa o espaço todo; footer fica no rodapé */}
                ...
                >
                  {token ? (
                    <>
                      ...
                      {tokenStatus === 'valid' && (
                        <form onSubmit={handleConfirm} className="space-y-4 pt-2" autoComplete="on">
                          <div>
                    ...
                    <>
                      ...
                      <form onSubmit={handleRequest} className="space-y-4 pt-2" autoComplete="on">
                        <div>
                          <label className="flex items-center gap-2 text-sm font-medium text-zinc-300 mb-1">
